                   ...
                   var condition, callback, time, event = "select" === el.tagName.toLowerCase() || ["checkbox", "radio"].includes(el.type) || directive.modifiers.includes("lazy") ? "change" : "input",
                       handler = (condition = hasDebounceModifier || DOM.isTextInput(el) && !isLazy, callback = function(e) {
                           var model = directive.value,
                               el = e.target,
                               value = e instanceof CustomEvent && void 0 !== e.detail && void 0 === window.document.documentMode ? e.detail || e.target.value : DOM.valueFromInput(el, component);
   ...
   var Component = function() {
       ...
       return _createClass(Component, [{
           ...
           value: function() {
               ...
               })(this.el.nextSibling) > 0 && console.warn("Livewire: Multiple root elements detected. This is not supported. See docs for more information https://laravel-livewire.com/docs/2.x/rendering-components#returning-blade", this.el)
           }
       }, {
           key: "initialize",
           value: function() {
