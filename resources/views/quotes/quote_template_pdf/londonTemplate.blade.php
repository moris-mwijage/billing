        ...
        <tr class="invoice-items">
            <td colspan="2">
                ...
                ; border-bottom: 2px solid {{ $quote_template_color }}">
                    ...
                    <tbody {{ $styleCss }}="border-bottom: 1px solid {{ $quote_template_color }};">
                ...
                <table class="invoice-footer">
                    ...
                    <tr>
                        <td class="font-weight-bold tu"
                            {{ $styleCss }}="color:{{ $quote_template_color }}; font-size: 17px">
