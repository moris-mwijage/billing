...
<body>
    ...
    <div
        {{ $styleCss }}="border-top: 15px solid {{ $quote_template_color }}
;border-bottom: 15px solid {{ $quote_template_color }}">
        <table width="100%" class="mt-4">
            <tr>
                <td>
                    <div class="logo"><img width="100px" src="{{ getLogoUrl($quote->tenant_id) }}" alt="">
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <span
                        {{ $styleCss }}="color: {{ $quote_template_color }}">{{ html_entity_decode(getAppName($quote->tenant_id)) }}</span><br>
        ...
        <table width="100%" class="mb-5">
            <tr class="invoice-items">
                ...
                ;border-bottom: 2px solid {{ $quote_template_color }}">
                        ...
                        <tbody {{ $styleCss }}="border-bottom: 3px solid {{ $quote_template_color }}">
