            ...
            <div class="modal-body scroll-y">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['id'=>'editCurrencyName','class' => 'form-control form-control-solid','required','placeholder' => __('messages.common.name')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('icon',__('messages.currency.icon').':', ['class' => 'form-label required mb-3']) }}
                        {{ Form::text('icon', null, ['id'=>'editCurrencyIcon','class' => 'form-control form-control-solid','required','placeholder' => __('messages.currency.icon')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('code', __('messages.currency.currency_code').':', 
                            ['class' => 'required fw-bold fs-6 mb-2']) }}
                        {{ Form::text('code', null, ['class' => 'form-control form-control-solid mb-3 mb-lg-0', 'placeholder' =>                                        __('messages.currency.currency_code'), 'required','id'=>'editCurrencyCode']) }}
