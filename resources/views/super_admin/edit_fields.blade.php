<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', isset($superAdmin)?$superAdmin->contact:null, ['class' => 'form-control form-control-solid', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
    ...
    <div class="mb-3" io-image-input="true">
        ...
        <div class="d-block">
            <div class="image-picker">
                ...
                {{$styleCss}}="background-image: url('{{ !empty($superAdmin->profile_image) ? $superAdmin->profile_image :
