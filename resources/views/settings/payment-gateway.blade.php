                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2 mb-5 mt-4 mt-sm-10">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            ...
                            <span class="form-check-label fw-bold" for="stripe">{{ __('messages.setting.stripe') }}</span>&nbsp;&nbsp;
                        </label>
                    </div>
                    <div class="form-group col-sm-5 mb-5">
                    ...
                    <div class="form-group col-sm-2 mb-5 mt-4 mt-sm-10">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            ...
                            <span class="form-check-label fw-bold" for="paypal">{{ __('messages.setting.paypal') }}</span>&nbsp;&nbsp;
                        </label>
                    </div>
                    <div class="form-group col-sm-5 mb-5">
                    ...
                    <div class="form-group col-sm-2 mb-5 mt-4 mt-sm-10">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            ...
                            <span class="form-check-label fw-bold" for="razorpay">{{ __('messages.setting.razorpay') }}</span>&nbsp;&nbsp;
                        </label>
                    </div>
                </div>
                <div class="card-body">
