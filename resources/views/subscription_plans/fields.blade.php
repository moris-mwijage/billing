<div class="row">
    ...
    <div class="col-md-4 mb-5">
        <div class="form-group">
            ...
            {{ Form::text('name', null , ['class' => 'form-control form-control-solid','required','placeholder' => __('messages.subscription_plans.name'),'id'=>'name']) }}
        </div>
    </div>
    ...
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            ...
            {{ Form::select('frequency', $planType, null, ['required', 'id' => 'planType','class' => 'form-select io-select2 form-select-solid for_trail_required','required','data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
...
<div class="float-end d-flex mt-10">
