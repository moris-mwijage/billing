<div class="d-flex justify-content-center">
    @if (!empty($row->payments) && !empty($row->payments->last()))
        @if (
            ...
            <a data-turbo="false" title="{{ __('messages.invoice.make_payment') }}" data-bs-toggle="tooltip" class="payment btn px-0 text-info fs-3 py-2" href="{{ route('clients.payments.show', $row->id) }}"
