@role('super_admin')
    ...
    <li
        class="nav-item {{ Request::is('super-admin/section-one*', 'super-admin/section-two*', 'super-admin/section-three*', 'super-admin/admin-testimonial*', 'super-admin/faqs*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page"
