...
@role('super_admin')
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('super-admin/section-one*', 'super-admin/section-two*', 'super-admin/section-three*', 'super-admin/faqs*', 'super-admin/admin-testimonial*') ? 'd-none' : '' }}">
