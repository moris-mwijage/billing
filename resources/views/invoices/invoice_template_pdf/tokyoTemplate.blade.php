...
<body>
    ...
    <div
        {{ $styleCss }}="border-top: 15px solid {{ $invoice_template_color }}
;border-bottom: 15px solid {{ $invoice_template_color }}">
        <table width="100%" class="mt-4">
            ...
            <tr>
                <td>
                    <span
                        {{ $styleCss }}="color: {{ $invoice_template_color }}">{{ html_entity_decode($setting['app_name']) }}</span><br>
        ...
        <tr>
            <td colspan="2" class="vertical-align-bottom">
                ...
                <span {{ $styleCss }}="color: {{ $invoice_template_color }}">{{ $setting['app_name'] }}</span>
            </td>
        </tr>
        </table>
    </div>
