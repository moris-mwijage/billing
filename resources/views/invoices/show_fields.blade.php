                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="d-flex align-items-center mb-md-10 mb-5">
                                                <div class="image image-circle image-small">
                                                    <img src="{{ getLogoUrl($invoice->tenant_id) }}" alt="logo"
                                                        class="object-contain" style="width: 100px">
                                                </div>
                                                    ...
                                                    @foreach ($invoice->invoiceItems as $index => $invoiceItem)
                                                        <tr>
                                                            ...
                                                            <td class="py-4 min-width-130px">
                                                                {{ !empty($invoiceItem->price) ? getInvoiceCurrencyAmount($invoiceItem->price, $invoice->currency_id, true, $invoice->tenant_id) : 'N/A' }}
                                                            </td>
                                                            <td class="py-4">
                                                            ...
                                                            <td class="py-4 min-width-130px">
                                                                {{ !empty($invoiceItem->total) ? getInvoiceCurrencyAmount($invoiceItem->total, $invoice->currency_id, true, $invoice->tenant_id) : 'N/A' }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-900 text-end pe-0">
                                                                {{ !empty($invoice->amount) ? getInvoiceCurrencyAmount($invoice->amount, $invoice->currency_id, true, $invoice->tenant_id) : 'N/A' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ps-0">
                                    ...
                                    <div
                                        ...
                                        <div class="row">
                                            ...
                                            @if (!$auth && $paid !== $invoice->final_amount)
                                                <a target="_blank" href="{{ route('client.invoices.index') }}"
