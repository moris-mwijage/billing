        ...
        <div class="fv-row">
            <div>
                ...
                <div class="position-relative">
                    <input class="form-control form-control-solid password"
    ...
    <div class="col-md-6 mb-5">
        <div class="fv-row">
            <div>
                ...
                <div class="position-relative">
                    <input class="form-control form-control-solid c-password"
                           type="password"
        ...
        <div class="mb-5" io-image-input="true">
            ...
            <div class="d-block">
                <div class="image-picker">
                    ...
                    style="background-image: url('{{ !empty($client->user->profile_image) ? $client->user->profile_image :
