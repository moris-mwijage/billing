...
class SettingRepository extends BaseRepository
{
    ...
    public function getSyncList(): mixed
    {
        return Setting::toBase()->pluck('value', 'key')->toArray();
    }

    public function getSyncListForSuperAdmin(): mixed
    {
    ...
    public function updateSuperAdminSetting(array $input)
    {
        ...
        $settingHomePageSupportLink = SuperAdminSetting::where('key', '=', 'home_page_support_link')->first();
        $settingHomePageSupportLink->update(['value' => $input['home_page_support_link']]);
