...
class AdminRazorpayController extends AppBaseController
{
    ...
    public function onBoard(Request $request): JsonResponse|Redirector|RedirectResponse|Application
    {
        $input = $request->all();
    ...
    public function paymentSuccess(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        try {
            ...
            $toastData = [
                'toastType' => 'success',
                'toastMessage' => $subscription->subscriptionPlan->name.' '.__('messages.flash.has_subscribed'),
            ];
    ...
    public function paymentFailed(Request $request): JsonResponse|Redirector|Application|RedirectResponse
    {
        try {
            ...
            $toastData = [
                'toastType' => 'error',
                'toastMessage' => __('messages.flash.unable_to_process_the_payment'),
            ];
