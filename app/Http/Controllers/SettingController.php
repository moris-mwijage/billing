...
class SettingController extends AppBaseController
{
    ...
    //Invoice Update
    public function invoiceUpdate(Request $request): Redirector|Application|RedirectResponse
    {
     ...
     *
     */
    public function editSuperAdminSettings(Request $request): \Illuminate\View\View
    {
    ...
    public function editSuperAdminFooterSettings(): View|Factory
    {
    ...
    public function updateSuperAdminFooterSettings(UpdateSuperAdminFooterSettingRequest $request): Redirector|RedirectResponse
    {
    ...
    public function invoiceSettings(): View|Factory|Application
    {
